    ...
    <div class="w-100 apartmentHolder">
        <div class="addApartment">
            <div class="p-3 text-center">
                ...
                <div class="p-3" v-if="!selected_user">
        ...
        <div class="viewApartment" style="height: 500px; padding: 30px; overflow-y: scroll; text-align: center;" v-if="user_list.length > 0">
...
export default {
    ...
    methods: {
        ...
        editUser(user) { 
            ...
            this.selected_user_role = user.role_id
        ...
        async saveUser() {
            ...
            if (!this.selected_user && (!this.password || this.password.trim() == '')) {
                Swal.fire({
                    position: 'top-end',
                    icon: 'error',
